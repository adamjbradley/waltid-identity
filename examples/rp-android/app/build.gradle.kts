...
android {
    namespace = "id.walt.verify.example"
    compileSdk = 34

    defaultConfig {
        applicationId = "id.walt.verify.example"
        minSdk = 26
        targetSdk = 34
        versionCode = 1
        versionName = "1.0"
...
dependencies {
    // walt.id Verify SDK dependencies (SDK source included in this example)
    // When SDK is published to Maven, replace these with:
    // implementation("id.walt:waltid-verify-sdk-android:1.0.0-SNAPSHOT")

    // Ktor HTTP Client (for SDK)
